...
<a id="connection-guides"></a>
<a href="#connection-guides" aria-label="Expandable sections hint">
  <img src="docs/assets/click-to-expand.svg" alt="Click the arrows below to expand each section" width="980">
</a>
